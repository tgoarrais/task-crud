...
@RestController // Indica que essa classe é um controlador REST, que responde a solicitações HTTP.
@RequestMapping("/users") // Define o caminho base para todas as solicitações HTTP que serão tratadas por essa classe.
